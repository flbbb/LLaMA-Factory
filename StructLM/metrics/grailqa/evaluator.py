...
reverse_properties, relation_dr, relations, upper_types, types = process_ontology(
    fb_roles, fb_types, reverse_properties
)
matcher = SemanticMatcher(
    reverse_properties, relation_dr, relations, upper_types, types
)
