...
class EvaluateTool(object):
    ...
    def __init__(self, args):
        self.args = args
        self.blec_test = BLECSpider(
            template_path="third_party/BLEC/template_to_names_test.json"
        )
        self.blec_dev = BLECSpider(
            template_path="third_party/BLEC/template_to_names_dev.json"
        )
